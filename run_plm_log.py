...
def main():
    ...
    if model_args.config_name:
        ...
        config = XLNetConfig(vocab_size=3420, n_head=2, n_layer=2, initializer_range=0.02, d_inner=32)
    ...
    if model_args.tokenizer_name == "netflix_prize":
        tokenizer = XLNetTokenizer(vocab_file='./spm/logdata.model')
    elif model_args.tokenizer_name == "ml-1m":
        tokenizer = XLNetTokenizer(vocab_file='./spm/ml-1m-seq.model')
    ...
    if training_args.do_train:
        ...
        trainer.save_model('./XLNet4RecModel')  # Saves the tokenizer too for easy upload
